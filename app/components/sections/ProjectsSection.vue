              ...
              >
                ...
                <div>
                  ...
                  <div v-if="project.hasInteractiveDemo" class="mb-8 flex flex-wrap items-center gap-3">
                    ...
                    <a
                      v-if="project.githubDemoUrl"
                      :href="project.githubDemoUrl"
                      target="_blank"
                      rel="noopener"
                      class="inline-flex items-center gap-1.5 text-xs font-semibold text-ink bg-white border border-border px-4 py-3 rounded-full hover:border-ink/50 transition-colors shadow-xs"
                      title="View Demo Source Code on GitHub"
                    >
